...
function customizer_library_nikkon_options() {
    ...
    $panels[] = array(
        'id' => $panel,
        'title' => __( 'Layout Settings', 'nikkon' ),
        'priority' => '30'
    );
    ...
    $options['nikkon-note-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Setting to change Sidebar width<br />- Enable Blocks layout on any/all pages<br />- Page featured image + layout settings<br /><br />- Set Shop, Archive & Single pages to Left Sidebar<br />- Set Shop, Archive & Single pages to full width<br />- Set WooCommerce products per page<br />- Set WooCommerce products per row<br />- Remove Products border', 'nikkon' )
    );
    ...
    $options['nikkon-note-footer'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Premium has an advanced widget footer layout where you can select the columns and manually adjust each column width as you want', 'nikkon' )
    );
    ...
    $options['nikkon-note-blog-layout'] = array(
        ...
        'section' => $section,
        'type'    => 'upsell',
        'description' => __( '<b>Premium Extra Features:</b><br />- Select Blog layout columns amount (Columns to be 2/3/4/5 layout per row)', 'nikkon' )
    );
