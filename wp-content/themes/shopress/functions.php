...
function shopress_read_more() {
	
	global $post;
	
	$readbtnurl = '<a class="btn btn-theme" href="' . get_permalink() . '">'.__('Read More','shopress').'</a>';
	
    return $readbtnurl;
}
add_filter( 'the_content_more_link', 'shopress_read_more' );